...
function BestSelling() {
  return (
    <div className="min-h-[30vh] container mb-10 mx-auto mt-[10rem]">
      <h1 className="text-2xl text-black font-semibold">Best Selling</h1>
      <div className="lg:flex lg:justify-between container mx-auto">
        <div className="mt-10 flex mx-auto justify-center lg:mt-0">
          <Tabs defaultValue="men" className="w-[400px] lg:w-full">
            <TabsList className="space-x-10 flex justify-center mt-5">
            ...
            {/* Men */}
            <TabsContent value="men" className="mt-10">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 place-items-center mx-auto">
            ...
            {/* Women */}
            <TabsContent value="women" className="mt-10">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 place-items-center mx-auto">
            ...
            {/* Kids */}
            <TabsContent value="kids" className="mt-10">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 place-items-center mx-auto">
